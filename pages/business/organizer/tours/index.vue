<template>
  ...
  <div class="page-header d-flex justify-content-between align-items-center mb-3">
    ...
    <NuxtLink to="/business/organizer/tours/new" class="btn btn-primary btn-sm">
    ...
    <div class="card border-0 shadow-sm">
      <div class="list-group list-group-flush">
        <div v-for="t in tours" :key="t.id" class="list-group-item d-flex align-items-center gap-3">
          ...
          <NuxtLink :to="`/business/organizer/tours/${t.slug || t.id}`" class="btn btn-outline-secondary btn-sm">
            Bearbeiten
          </NuxtLink>
        </div>
      </div>
...
const api = useApi()
const { data, pending, error } = await useAsyncData('organizer-tours', () =>
  api.get('/business/organizer/tours').then(r => r.data)
)
